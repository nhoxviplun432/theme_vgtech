...
$my_orders_columns = apply_filters(
	...
	array(
		'order-number'  => esc_html__( 'ID Order', 'woocommerce' ),
		'order-date'    => esc_html__( 'Ngày', 'woocommerce' ),
...
<!-- 	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table"> -->
	<table border="1" style="width:100%; border-collapse:collapse; text-transform:capitalize;" cellpadding="10">
		<!-- <thead>
			<tr>
